...
function Footer() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="1"
      className="flex gap-5 w-full h-screen bg-zinc-900 p-20"
    >
      <div className="w-1/2 h-full flex flex-col justify-between font-['momcake'] leading-[8vw] text-white -mb-10 ">
        <div className="heading py-10">
          <h1 className="text-[10vw] font-semibold tracking-tight">EYE -</h1>
          <h1 className="text-[10vw] font-semibold tracking-tight">OPENING</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 mr-5">
        <h1 className="text-[9vw] font-semibold uppercase tracking-tighter font-['momcake']">
          PRESENTATIONS
        </h1>
        <div className="header">
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo,
            magnam molestias minus animi velit placeat iusto laudantium ipsa
            tempore non temporibus laborum dignissimos provident ad unde, quos,
            officia repudiandae sunt.
          </p>
        </div>
        <div className="dets flex flex-col pt-7">
          <div className="social">
            <h3 className="text-2xl uppercase font-light ">social media</h3>
          </div>
          <div className="icons flex pt-5">
            {[
              <FaFacebookSquare />,
              <FaInstagramSquare />,
              <FaLinkedin />,
              ...
              <a
                key={index}
                className="m-2 text-md font-light text-3xl uppercase"
              >
                {item}
              </a>
            ))}
          </div>
          <div className="location pt-7">
            <h3 className="text-2xl uppercase font-light ">address</h3>
            <h2 className="text-md pt-5">
              202-1965 W 4th Ave Vancouver, Canada 30 Chukarina St Lviv, Ukraine
            </h2>
          </div>
        </div>
      </div>
